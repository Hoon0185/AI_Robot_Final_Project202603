...
class RFIDLocalizationNode(Node):
    def __init__(self):
        ...
        self.landmark_map = {
            428801199154: {'x': 0.6213, 'y': 1.6028, 'yaw': 0.0},  # Shelf 1 (TAG-A1-001)
            111222333444: {'x': -1.0341, 'y': 1.5040, 'yaw': 0.0}, # Shelf 2 (TAG-A2-002) - ID 확인 필요
            291971004317: {'x': -1.0189, 'y': -0.2340, 'yaw': 0.0}, # Shelf 3 (TAG-B1-003)
            555666777888: {'x': 0.8633, 'y': -0.0053, 'yaw': 0.0}   # Shelf 4 (TAG-B2-004) - ID 확인 필요
        }
